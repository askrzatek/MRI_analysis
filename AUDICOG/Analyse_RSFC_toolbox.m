...
par.run = 0;
par.sge = 1;
par.jobname = 'timeseries_extract_AUDICOG_wo_LC'
par.display = 0;
par.redo = 0;
...
%        char(get_subdir_regex_files(path_masks_Alert, 'LC')),          'LC',        'Bilateral_Locus_Coereleus'
...
par.jobname = 'seed2brain_analysis_AUDICOG_wo_LC';

...
par.roi_type.mask_global = vertcat(atlas_rois_list_SMN, atlas_rois_list_Vis, {
%     % path                                                           abbrev          description
...
par.outname = 'AUDICOG_CAREN_SM_Visual_Net_Tinnitus_Alert_Audio';
...
%    src =  fullfile( e(isubj).getSerie('run_RS').path, 'tedana009a1_vt/rsfc/timeseries__AUDICOG_CAREN_SN_CEN_DMN_AudioACT.mat') ;
    dst_SMN = fullfile( e(isubj).getSerie('run_RS').path, 'tedana009a1_vt/rsfc/timeseries__AUDICOG_CAREN_SN_CEN_DMN_AudioACT.mat');
    dst_Vis = fullfile( e(isubj).getSerie('run_RS').path, 'tedana009a1_vt/rsfc/timeseries__Salience_Tinnitus_Alert_Audio.mat') ;

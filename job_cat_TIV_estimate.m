...
%                 {'/network/iss/cenir/analyse/irm/users/anna.skrzatek/nifti_test/2018_07_18_PARKGAMEII_001_NB_18_07_2018_V1_a/S03_t1mpr_S256_0_8iso_p2/cat_v_PARKGAMEII_001_NB_18_07_2018_V1_S3_t1mpr_S256_0_8iso_p2.xml'};
% par.fname : string output file name
%         'TIV'
% par.foutdir : string outdir path for the file to be created
%           '/network/iss/cenir/analyse/irm/users/anna.skrzatek/nifti_test/'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% par structure
    ...
    defpar.run = 1;
    defpar.fname = 'TIV';
    defpar.foutdir = '/network/iss/cenir/analyse/irm/users/anna.skrzatek/nifti_test/';

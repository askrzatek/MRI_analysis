function jobs = job_second_level_contrast(fspm,contrast,par)
...
%         jobs{idx}.spm.stats.results.conspec.threshdesc = 'none';
%         jobs{idx}.spm.stats.results.conspec.thresh = 0.001;
%         jobs{idx}.spm.stats.results.conspec.extent = 20;
...
%         jobs{idx}.spm.stats.results.write.none = 0;
        
        jobs{idx}.spm.stats.results.spmmat = fspm(nbs);
        jobs{idx}.spm.stats.results.conspec.titlestr = '';
        jobs{idx}.spm.stats.results.conspec.contrasts = Inf;
        jobs{idx}.spm.stats.results.conspec.threshdesc = 'none';
        jobs{idx}.spm.stats.results.conspec.thresh = 0.01;
        jobs{idx}.spm.stats.results.conspec.extent = 15;
        jobs{idx}.spm.stats.results.conspec.conjunction = 1;
        %matlabbatch{1}.spm.stats.results.conspec.mask.image.name = '<UNDEFINED>';
        %matlabbatch{1}.spm.stats.results.conspec.mask.image.mtype = '<UNDEFINED>';
        jobs{idx}.spm.stats.results.units = 1;
        jobs{idx}.spm.stats.results.print = false;
        jobs{idx}.spm.stats.results.write.tspm.basename = 'th_con';
        idx=idx+1;
    end

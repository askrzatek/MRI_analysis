...
% fsub = {'/network/lustre/iss02/cenir/analyse/irm/users/anna.skrzatek/nifti/2019_02_27_REMINARY_HM_005_V2/model_meica/'} % EXAMPLE for one subject
%
...
% .DISPLAY       : (0/1)
% .REDO          : (0/1) overwriting the exhtopisting files (1) or not (0)
...
%% defpar
    ...
    defpar.redo = 0;
    defpar.anat_dir_reg = 't1mpr_S256_0_8iso_p2$';

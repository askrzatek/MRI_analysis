...
% skip if p0_ exist
    ...
    jobs{nbsuj}.spm.tools.cat.estwrite.opts.tpm = {'/network/iss/cenir/software/irm/spm12/tpm/TPM.nii'};
    ...
    jobs{nbsuj}.spm.tools.cat.estwrite.extopts.registration.darteltpm = {'/network/iss/cenir/software/irm/spm12/toolbox/cat12/templates_1.50mm/Template_1_IXI555_MNI152.nii'};
    jobs{nbsuj}.spm.tools.cat.estwrite.extopts.registration.shootingtpm = {'/network/iss/cenir/software/irm/spm12/toolbox/cat12/templates_1.50mm/Template_0_IXI555_MNI152_GS.nii'};

...
%     dst2_cort = fullfile(e(isubj).getSerie('RS').path,'rsfc/timeseries__Dystonic_PPN_SMN_AssBG_AssAnt_AssPost_Limbic_Primary.mat');
    dst2_cort = fullfile(e(isubj).getSerie('RS').path,'rsfc/timeseries__Dystonic_PPN_SMN.mat');
...
%% CORTICAL NETWORKS
    ...
    ifile_out = [e(isubj).name, '_idx' , num2str(isubj) ,'_connectivity_RS_DysPPN_SMN_timeseries.csv' ]; 
    ...
    ifile_out = [e(isubj).name , '_idx', num2str(isubj) ,'_connectivity_RS_DysPPN_SMN_static_conn.csv' ]; 
    ...
    ifile_out = 'Connectivity_RS_DysPPN_SMN_labels.csv';

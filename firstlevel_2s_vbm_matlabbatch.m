function matlabbatch = firstlevel_2s_vbm_matlabbatch(subj,outdir,covars,par)
%%
    ...
    for iS = 1: length(subj)
        ...
        jobs{ijob}.spm.stats.factorial_design.des.t2.scans1 = spm_select('expand',subj{iS}(1));
        jobs{ijob}.spm.stats.factorial_design.des.t2.scans2 = spm_select('expand',subj{iS}(2));
        %     {

...
fsub = {'/network/iss/cenir/analyse/irm/users/anna.skrzatek/nifti/secondlevel_ACTIVATION_PARK_S1/'};
...
spm('defaults', 'FMRI');
    ...
    jobs{1}.spm.stats.results.spmmat = {'/network/iss/cenir/analyse/irm/users/anna.skrzatek/nifti/secondlevel_ACTIVATION_PARK_S1/ANOVA2x2_LxT/SPM.mat'};
